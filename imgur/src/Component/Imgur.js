...
class Imgur extends React.Component{  // using class component
constructor(){
    super()
    this.state={              
    ...
    return(
        <div className="photos-container">
        {
            data.map((item)=>{         
                ...
                <div className='Imgur-photos'><img src={item.largeImageURL} alt='loading...' className='image'></img>
...
export default Imgur;  // exporting the component